...
Este projeto tem como objetivo realizar uma análise de dados de diversos datasets. 
Coloco em prática a exploração, limpeza, visualização e modelagem de dados para extrair informações e gerar insights.
O código está estruturado em notebooks, facilitando a execução e a colaboração em tempo real.
...
Este projeto é flexível e pode utilizar diversos conjuntos de dados públicos, desde que devidamente licenciados. Ao utilizar um novo conjunto de dados, a licença correspondente será especificada nos arquivos `LICENSE` de licença específicos.
...
Jan M.([https://github.com/seu-usuario](https://github.com/potatoesAndMolasses))
